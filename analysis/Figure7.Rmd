...
```{r, figure7, fig.cap = 'Figure 7: Replication of figure 7, displaying density distributions of the number of followers that the accounts generating viral tweets. Showing statistical significance in the difference between the distributions.', warning=FALSE}
